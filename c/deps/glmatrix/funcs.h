...
typedef GLMfloat *vec3_t;
typedef GLMfloat *vec4_t;
typedef GLMfloat *mat3_t;
typedef GLMfloat *mat4_t;
typedef GLMfloat *quat_t;
 ...
 * dest if not NULL, vec otherwise
 */
vec3_t vec3_scale(vec3_t vec, GLMfloat val, vec3_t dest);
 ...
 * Length of vec
 */
GLMfloat vec3_length(vec3_t vec);
 ...
 */
GLMfloat vec3_dot(vec3_t vec, vec3_t vec2);
...
vec3_t vec3_lerp(vec3_t vec, vec3_t vec2, GLMfloat lerp, vec3_t dest);
 ...
 */
GLMfloat vec3_dist(vec3_t vec, vec3_t vec2);
 ...
 * determinant of mat
 */
GLMfloat mat4_determinant(mat4_t mat);
 ...
 * dest if not NULL, vec otherwise
 */
vec3_t mat4_multiplyVec4(mat4_t mat, vec4_t vec, vec3_t dest);
 ...
 * dest if not NULL, mat otherwise
 */
mat4_t mat4_rotate(mat4_t mat, GLMfloat angle, vec3_t axis, mat4_t dest);
 ...
 * dest if not NULL, mat otherwise
 */
mat4_t mat4_rotateX(mat4_t mat, GLMfloat angle, mat4_t dest);
 ...
 * dest if not NULL, mat otherwise
 */
mat4_t mat4_rotateY(mat4_t mat, GLMfloat angle, mat4_t dest);
 ...
 * dest if not NULL, mat otherwise
 */
mat4_t mat4_rotateZ(mat4_t mat, GLMfloat angle, mat4_t dest);
 ...
 * dest if not NULL, a new mat4_t otherwise
 */
mat4_t mat4_frustum(GLMfloat left, GLMfloat right, GLMfloat bottom, GLMfloat top, GLMfloat near, GLMfloat far, mat4_t dest);
 ...
 * dest if not NULL, a new mat4_t otherwise
 */
mat4_t mat4_perspective(GLMfloat fovy, GLMfloat aspect, GLMfloat near, GLMfloat far, mat4_t dest);
 ...
 * dest if not NULL, a new mat4_t otherwise
 */
mat4_t mat4_ortho(GLMfloat left, GLMfloat right, GLMfloat bottom, GLMfloat top, GLMfloat near, GLMfloat far, mat4_t dest);
 ...
 */
GLMfloat quat_dot(quat_t quat, quat_t quat2);
 ...
 * Length of quat
 */
GLMfloat quat_length(quat_t quat);
 ...
 * dest if not NULL, quat otherwise
 */
quat_t quat_slerp(quat_t quat, quat_t quat2, GLMfloat slerp, quat_t dest);
